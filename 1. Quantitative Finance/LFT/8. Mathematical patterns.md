...
| Strategy | Sharpe | 6m-return | 1y-return | 3y-return |
| ------------- |-------------| -------------| -------------| -------------|
| Strategy 1 - unoptimized| 0.29 | 3% | 3.26% | -7.9% |
| Strategy 2 - unoptimized| -14.21 | -65.4% | -159% | -258.66% |
| Strategy 3| -1.22 | NAN | -20.41% | -29.4% |
| Strategy 4| 0.56 | 0.6% | 6.3% | -0.96% |
| Strategy 5| -1.82 | -0.6% | -20.4% | -39.2% |
| unoptimized 5-15-30 - 5y - 53%| 1.64 | 3.3% | 18.32% | 10.5% | 
...
### Strategy 2 - extremely unoptimized - private collection
This strategy performs very badly on this scenario, as it trades frequently, but expects very low brokerage fee.

if number of positive returns vs negative returns is above the ten day average and the previous days number of positive vs negative was also above the average.
then buy.

if yesterday was a buy signal and todays return is negative.
Then sell

if the number of postive returns vs negative returns is below the 30 day average.
Then Short sell

if yesterday was a short-sell and today's returns are positive.
Then close your short sell.
