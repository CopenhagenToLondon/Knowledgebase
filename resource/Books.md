...
* **Covariance matrix testing in high dimensions using random projections**
  ...
  * [NONLINEAR SHRINKAGE ESTIMATION OF LARGE-DIMENSIONAL COVARIANCE MATRICES](https://arxiv.org/pdf/1207.5322.pdf)
  * [Noise Dressing of Financial Correlation Matrices](https://arxiv.org/pdf/cond-mat/9810255.pdf)
  * [Tuning the Parameters for Precision Matrix Estimation Using Regression Analysis](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=8755295)
  * [An Overview on the Estimation of Large Covariance and Precision Matrices](https://arxiv.org/pdf/1504.02995.pdf)
  * [Distributionally Robust Inverse Covariance Estimation: The Wasserstein Shrinkage Estimator](https://arxiv.org/pdf/1805.07194.pdf)
  * [The Distance Precision Matrix: computing networks from non-linear relationships](https://academic.oup.com/bioinformatics/article/35/6/1009/5079333)
  * [A Comparison of Methods for Estimating the Determinant of High-Dimensional Covariance Matrix](https://www.math.hkbu.edu.hk/~tongt/papers/IJB2017.pdf)
  * [Optimal Shrinkage Estimation of Variances With Applications to Microarray Data Analysis](https://www.researchgate.net/publication/4742786_Optimal_Shrinkage_Estimation_of_Variances_With_Applications_to_Microarray_Data_Analysis)
  * [DYNAMIC PORTFOLIO OPTIMIZATION WITH INVERSE COVARIANCE CLUSTERING](https://arxiv.org/pdf/2112.15499.pdf)
  * [Portfolio Optimization with Sparse Multivariate Modelling](https://www.researchgate.net/publication/350484158_Portfolio_Optimization_with_Sparse_Multivariate_Modelling)
  * [HIGH-DIMENSIONAL PRECISION MATRIX ESTIMATION WITH A KNOWN GRAPHICAL STRUCTURE](https://arxiv.org/pdf/2107.06815.pdf)
  * [The Graphical Lasso: New Insights and Alternatives](https://hastie.su.domains/Papers/glasso_revisit_trevor_arxiv.pdf)
  * [Covariance Prediction via Convex Optimization](https://stanford.edu/~boyd/papers/pdf/forecasting_covariances.pdf)
  ...
  * [An Linfinity Eigenvector Perturbation Bound and Its Application to Robust Covariance Estimation](https://www.jmlr.org/papers/volume18/16-140/16-140.pdf)
  * [Cumulative Distribution Functions and UPM/LPM Analysis](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2148482)
* [Filtering Noise from Correlation Matrices (Detection of Correlation Diversion, Pairs Trading, Risk Analysis Et al)](https://papers.ssrn.com/sol3/Delivery.cfm/SSRN_ID2378911_code2184499.pdf?abstractid=2378911&mirid=1)
* [Reliable Covariance Estimation](https://arxiv.org/pdf/2006.03311v3.pdf)
* [Regularized M-estimators of scatter matrix](https://arxiv.org/pdf/1405.2528.pdf)
* [cvCovEst: Cross-validated covariance matrix estimator selection and evaluation in R](https://www.researchgate.net/publication/353470417_cvCovEst_Cross-validated_covariance_matrix_estimator_selection_and_evaluation_in_R)
* [Online Cross-Validation-Based Ensemble Learning](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5671383/pdf/nihms870890.pdf)
* [Advances in High-Dimensional Covariance Matrix Estimation](https://depositonce.tu-berlin.de/handle/11303/5357)
* [Estimation of Theory-Implied Correlation Matrices](https://papers.ssrn.com/sol3/Delivery.cfm/SSRN_ID3484152_code434076.pdf?abstractid=3484152&mirid=1)
* [The Myth of Diversification Reconsidered](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3781844)
